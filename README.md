...
You should write your own code using the Scrabble class and test the methods manually to ensure they work properly.  
...
### Primary Requirements
Create a new `Player` class. The class should have the following methods:
...
- Examine the Scrabble tests we wrote in our Ruby project, and see if you can write some code which tests your JavaScript project's functionality.  
